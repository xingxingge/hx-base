...
public class FileSystemResource extends AbstractResource {
  ...
  public FileSystemResource(File file) {
    this.file = file;
    this.path = PathUtils.cleanPath(file.getPath());
  }
   ...
   * makes a difference whether the specified resource base path here ends with
   * a slash or not. In the case of "C:/dir1/", relative paths will be built
