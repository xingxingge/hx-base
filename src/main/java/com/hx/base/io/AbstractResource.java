...
public abstract class AbstractResource implements Resource {
  ...
  public URI getURI() throws IOException {
    ...
    try {
      ...
      IOException e = new IOException("Invalid URI [" + url + "]");
      e.initCause(ex);
      throw e;
    }
  }
   ...
   * @throws IOException
   *           if the resource cannot be resolved as absolute file path, i.e. if
   *           the resource is not available in a file system
   */
  ...
  /**
   * This implementation always throws IllegalStateException, assuming that the
   * resource does not carry a filename.
   */
